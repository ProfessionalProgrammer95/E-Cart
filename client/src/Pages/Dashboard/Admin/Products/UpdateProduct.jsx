...
function UpdateProduct() {
    ...
    const readAllCat = async () => {
     ...
     const deleteImage = async (e) => {
        e.preventDefault()
        try{
            if(window.confirm(`Are you sure to delte an image?`)){
        ...
        <div className="row">
            ...
            <div className="col-md-6">
                <div className="form-group mt-2">
                    ...
                    <textarea name="desc" value={desc} onChange={(e) => setDesc(e.target.value)}  id="desc" cols="30" rows="10" className='form-control' required></textarea>
                </div>
                <div className="form-group mt-2">
